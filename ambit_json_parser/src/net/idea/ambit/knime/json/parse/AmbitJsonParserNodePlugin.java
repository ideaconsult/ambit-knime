 ...
 */
public class AmbitJsonParserNodePlugin extends Plugin {
	// The shared instance.
	private static AmbitJsonParserNodePlugin plugin;

	/**
	 * The constructor.
	 */
	public AmbitJsonParserNodePlugin() {
		super();
		plugin = this;
	}
	 ...
	 */
	public static AmbitJsonParserNodePlugin getDefault() {
		return plugin;
	}
