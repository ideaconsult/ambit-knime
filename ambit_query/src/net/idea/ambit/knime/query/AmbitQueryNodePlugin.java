 ...
 */
public class AmbitQueryNodePlugin extends Plugin {
    // The shared instance.
    private static AmbitQueryNodePlugin plugin;

    /**
     * The constructor.
     */
    public AmbitQueryNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static AmbitQueryNodePlugin getDefault() {
        return plugin;
    }
