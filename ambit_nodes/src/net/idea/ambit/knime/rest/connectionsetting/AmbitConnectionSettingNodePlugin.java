 ...
 */
public class AmbitConnectionSettingNodePlugin extends Plugin {
    // The shared instance.
    private static AmbitConnectionSettingNodePlugin plugin;

    /**
     * The constructor.
     */
    public AmbitConnectionSettingNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static AmbitConnectionSettingNodePlugin getDefault() {
        return plugin;
    }
